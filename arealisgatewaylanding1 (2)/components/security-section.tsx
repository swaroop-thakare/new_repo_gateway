          ...
          <div className="relative grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
            <div className="space-y-6">
              ...
              <div className="space-y-4 pt-4">
                <div
                  className="flex items-start gap-3 p-4 rounded-lg shadow-md backdrop-blur-sm border
            ...
            <div className="relative">
              <div
                className="rounded-2xl p-8 space-y-6 shadow-xl backdrop-blur-sm border
              bg-gradient-to-br from-blue-50/80 via-cyan-50/60 to-blue-50/80
              dark:from-blue-950/30 dark:via-cyan-950/20 dark:to-blue-950/30
              border-blue-200/50 dark:border-blue-800/30"
              >

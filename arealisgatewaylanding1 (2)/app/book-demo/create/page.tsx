...
import { uploadBatchFile } from "@/lib/api-client"
...
export default function CreatePage() {
  ...
  const handleFileUpload = async (file: File) => {
    if (!healthy) {
      setUploadResult("Backend service is not available. Please check the connection.")
      return
    }
    ...
    try {
      const result = await uploadBatchFile(file, "AXIS")
      setUploadResult(`Upload successful! Batch ID: ${result.batch_id}`)
        ...
        <TabsContent value="batch" className="space-y-6">
          <Card className="relative overflow-hidden border-white/10 bg-gradient-to-br from-blue-600/20 via-blue-500/10 to-transparent backdrop-blur-xl">
            ...
            <CardContent className="relative space-y-4">
              ...
              <div 
                className="flex min-h-[200px] items-center justify-center rounded-lg border-2 border-dashed border-blue-500/30 bg-gradient-to-br from-blue-600/10 to-blue-500/5 backdrop-blur-xl cursor-pointer hover:border-blue-400/50 transition-colors"
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button 
              ...
              disabled={!selectedFile || uploading || !healthy}

            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {reasons.map((reason, index) => {
                ...
                return (
                  <FadeIn
                    key={index}
                    className="group relative bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-white/15 dark:border-white/10 shadow-lg hover:shadow-xl transition-all hover:-translate-y-2"
                  >
                    <div

        ...
        <div className="relative rounded-3xl bg-white/60 dark:bg-[#0f0f0f]/60 backdrop-blur-xl border border-white/15 dark:border-white/10 p-8 md:p-12 lg:p-16 shadow-2xl overflow-hidden">
          ...
          <div className="relative space-y-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <FadeIn className="group relative bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-white/15 dark:border-white/10 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1">
